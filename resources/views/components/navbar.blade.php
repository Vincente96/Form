<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container px-5">
        <a class="navbar-brand" href="/login">Vincenzo Tisci</a>
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{route('welcome')}}"> <i class="bi bi-house"> </i></a></li>
                      ...
                      <li class="nav-item"><a href="{{route('categories.index')}}" class="nav-link">Categorie</a></li> 
                      <li class="nav-item"><a href="{{route('viewcounter')}}" class="nav-link">Gestione clienti</a></li> 
